                ...
                >
                  ...
                  <div className="p-6">
                    ...
                    <div className="space-y-3">
                      <Link 
                        href="/contact"
                        className="w-full bg-primary text-primary-foreground px-4 py-3 rounded-md text-sm font-medium hover:bg-primary/90 transition-colors flex items-center justify-center gap-2"
                      >
